...
I'm @[6aa9b0739decfdd1ed069971] @[6aa9b0739decfdd1ed069971]! and I'm working on [Preview deployment not created for a fork branch](/help-center/preview-deployment-not-created-for-fork-branch)

Check out our live site at [test](/quickstart) and also [Deployments](/deploy/deployments).
...
<Visibility for="agents">
  ...
  10. Run `mint status` to get the configured subdomain, then verify that `https://<subdomain>.mintlifysite.com` loads before reporting that deployment is complete.
...
Your documentation site is now deployed at `https://<your-project-name>.mintlifysite.com`.
